...
url = "https://graph.facebook.com/%s/posts?access_token=CAACEdEose0cBAPdoxAMx7yUycX39oaW00GoqlUx56VhuTuH5GdbrffunGYnmyDN1mXrEbG58ItsYRW5HZAOk8sfcWJDeYLDCKS1UrlsPNIX1BTR05eH1xkI3OknZC3RZCKY6XqzHCR1COgD8bckysAjooScngzwx7IRZBlbG3Fmc1o512wtlVGnvs5mj5qcpfQUKA3KxZCQZDZD&include_hidden=true" #paste your own access token here.
...
class Scrape:
    def __init__(self):   
        engine = sqlalchemy.create_engine("sqlite:///mining.sqlite", echo=False) #enter your database name here and its file path. 
    ...
    def main(self):
        ...
        keys = []
        ids = ['207176522787720', '823318454506854'] #if a page name contains multiple words, separated by space (e.g. SPOT Coffee); it will show up as words connected by hyphens in URL. For example, SPOT Cofee as in "Spot-Coffee-Elmwood." If so, it is recommended that you use page id. You can find page id in the URL - it is the string of numbers after page name in URL.  (e.g. https://www.facebook.com/pages/Spot-Coffee-Elmwood/316579834919)
        for feed in ids:
            kid = feed 
            d = get_data(kid)
